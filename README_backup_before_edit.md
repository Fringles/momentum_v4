...
- Exit caps:
  ...
  - Adaptive rule (per side, non‑rebal months):
...
- Timeseries: `results/momentum_br_timeseries.csv`
  - `D10`, `LS`, `turnover_D10`, `turnover_LS`, `turnover_LS_reconst`, `turnover_LS_reweight`, `CDI`, `BOVA11`, `LS_pre_overlay`, `beta_est`, `hedge_ratio`.
...
Run with defaults and 3 cohorts + overlay
